...
do { (mem).registerTransportCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, 0, #func ); } while(0)

#define MEMORY_REGISTER_TRANSPORT_USER( mem, func, id ) \
do { (mem).registerTransportCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, (id), #func ); } while(0)

#define MEMORY_REGISTER_READ( mem, func ) \
do { (mem).registerReadCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, 0, #func ); } while(0)

#define MEMORY_REGISTER_READ_USER( mem, func, id ) \
do { (mem).registerReadCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, (id), #func ); } while(0)

#define MEMORY_REGISTER_WRITE( mem, func ) \
do { (mem).registerWriteCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, 0, #func ); } while(0)

#define MEMORY_REGISTER_WRITE_USER( mem, func, id ) \
do { (mem).registerWriteCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, true, (id), #func ); } while(0)

#define MEMORY_REGISTER_NB_TRANSPORT( mem, func ) \
do { (mem).registerTransportCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, 0, #func ); } while(0)

#define MEMORY_REGISTER_NB_TRANSPORT_USER( mem, func, id ) \
do { (mem).registerTransportCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, (id), #func ); } while(0)

#define MEMORY_REGISTER_NB_READ( mem, func ) \
do { (mem).registerReadCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, 0, #func ); } while(0)

#define MEMORY_REGISTER_NB_READ_USER( mem, func, id ) \
do { (mem).registerReadCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, (id), #func ); } while(0)

#define MEMORY_REGISTER_NB_WRITE( mem, func ) \
do { (mem).registerWriteCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, 0, #func ); } while(0)

#define MEMORY_REGISTER_NB_WRITE_USER( mem, func, id ) \
do { (mem).registerWriteCB( this, &SC_CURRENT_USER_MODULE_TYPE::func, false, (id), #func ); } while(0)
