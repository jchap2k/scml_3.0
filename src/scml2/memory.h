...
class memory_initialize_api_owner
{
public:
  memory_initialize_api_owner() {}
  virtual ~memory_initialize_api_owner() {}

  virtual void initialize(const DT& value) = 0;
};
...
public:
  ...
  void initialize(const DT& value = DT()) override;
