...
public:
  ...
  virtual bool is_idle() const { return !(m_active_reads || m_active_writes); }
...
private:
  ...
  scml2::callback_event_enum phase_to_event_id(tlm::tlm_generic_payload& trans, tlm::tlm_phase& phase) const;

  ft_channel m_data_channel;
