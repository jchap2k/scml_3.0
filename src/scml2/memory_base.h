...
class SNPS_VP_API memory_restriction_api_owner
{
public:
  memory_restriction_api_owner() {}
  virtual ~memory_restriction_api_owner() {}

  virtual memory_access_restriction_base* get_read_restriction() const = 0;
  virtual memory_access_restriction_base* get_write_restriction() const = 0;

  virtual void set_restriction(memory_access_restriction_base* r) = 0;
  virtual void set_read_restriction(memory_access_restriction_base* r) = 0;
  virtual void set_write_restriction(memory_access_restriction_base* r) = 0;

  virtual void remove_read_restriction() = 0;
  virtual void remove_write_restriction() = 0;
};

class SNPS_VP_API memory_callback_api_owner
{
 public:
  memory_callback_api_owner() {}
  virtual ~memory_callback_api_owner() {}

  virtual void set_callback(memory_callback_base* cb) = 0;
  virtual void set_read_callback(memory_callback_base* cb) = 0;
  virtual void set_write_callback(memory_callback_base* cb) = 0;

  virtual void remove_callback() = 0;
  virtual void remove_read_callback() = 0;
  virtual void remove_write_callback() = 0;

  virtual memory_callback_base* get_read_callback() const = 0;
  virtual memory_callback_base* get_write_callback() const = 0;
};

class SNPS_VP_API memory_debug_callback_api_owner
{
public:
  memory_debug_callback_api_owner() {}
  virtual ~memory_debug_callback_api_owner() {}

  virtual void set_debug_callback(memory_debug_callback_base* cb) = 0;
  virtual void set_debug_read_callback(memory_debug_callback_base* cb) = 0;
  virtual void set_debug_write_callback(memory_debug_callback_base* cb) = 0;

  virtual void remove_debug_callback() = 0;
  virtual void remove_debug_read_callback() = 0;
  virtual void remove_debug_write_callback() = 0;

  virtual memory_debug_callback_base* get_debug_read_callback() const = 0;
  virtual memory_debug_callback_base* get_debug_write_callback() const = 0;
};
...
public:
  ...
  virtual void set_callback(memory_callback_base* cb) override;
  virtual void set_read_callback(memory_callback_base* cb) override;
  virtual void set_write_callback(memory_callback_base* cb) override;
  ...
  virtual memory_callback_base* get_read_callback() const override;
  virtual memory_callback_base* get_write_callback() const override;

  virtual void set_debug_callback(memory_debug_callback_base* cb) override;
  virtual void set_debug_read_callback(memory_debug_callback_base* cb) override;
  virtual void set_debug_write_callback(memory_debug_callback_base* cb) override;
  ...
  virtual memory_debug_callback_base* get_debug_read_callback() const override;
  virtual memory_debug_callback_base* get_debug_write_callback() const override;

  virtual memory_access_restriction_base* get_read_restriction() const override;
  virtual memory_access_restriction_base* get_write_restriction() const override;

  virtual void set_restriction(memory_access_restriction_base* r) override;
  virtual void set_read_restriction(memory_access_restriction_base* r) override;
  virtual void set_write_restriction(memory_access_restriction_base* r) override;

  virtual void remove_read_restriction() override;
  virtual void remove_write_restriction() override;
