...
void
memory_fast_access_impl<DT>::
doAdd(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
...
void
memory_fast_access_impl<DT>::
doSubtract(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] -= rhs;
}
...
void
memory_fast_access_impl<DT>::
doDivide(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] /= rhs;
}
...
void
memory_fast_access_impl<DT>::
doMultiply(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] *= rhs;
}
...
void
memory_fast_access_impl<DT>::
doModulo(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] %= rhs;
}
...
void
memory_fast_access_impl<DT>::
doXor(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] ^= rhs;
}
...
void
memory_fast_access_impl<DT>::
doAnd(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] &= rhs;
}
...
void
memory_fast_access_impl<DT>::
doOr(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] |= rhs;
}
...
void
memory_fast_access_impl<DT>::
doShiftRight(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] >>= rhs;
}
...
void
memory_fast_access_impl<DT>::
doShiftLeft(unsigned long long index, const DT& rhs)
{
  assert(mFastBackdoor);
  reinterpret_cast<DT*>(this->mFastBackdoor)[index] <<= rhs;
}
