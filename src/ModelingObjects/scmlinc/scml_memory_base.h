...
public:
  ...
  static constexpr unsigned int OPERATIONS_ALLOW_READ  = 1;
  static constexpr unsigned int OPERATIONS_ALLOW_WRITE = 2;
  static constexpr unsigned int OPERATIONS_ERROR_DISALLOWED_READ  = 4;
  static constexpr unsigned int OPERATIONS_ERROR_DISALLOWED_WRITE = 8;
