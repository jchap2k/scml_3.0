...
template <typename DT>
inline void set_ignore_restriction(bitfield<DT>& bf, DT value = DT(), DT mask = static_cast<DT>(~DT())) {
  bf.set_restriction(create_bitfield_restriction<DT>(create_ignore_restriction_adapter<DT>(value, mask), "ignore access restriction"));
}
...
template <typename DT>
inline void set_read_ignore_restriction(bitfield<DT>& bf, typename ignore_expr_restriction_adapter<DT>::RestrictionFunction f, DT value = DT()) {
  bf.set_read_restriction(create_bitfield_restriction<DT>(create_ignore_expr_restriction_adapter<DT>(f, value), "ignore read restriction"));
}

template <typename DT>
inline void set_write_ignore_restriction(bitfield<DT>& bf, typename ignore_expr_restriction_adapter<DT>::RestrictionFunction f, DT value = DT()) {
  bf.set_write_restriction(create_bitfield_restriction<DT>(create_ignore_expr_restriction_adapter<DT>(f, value), "ignore write restriction"));
}

template <typename DT>
inline void set_ignore_restriction(bitfield<DT>& bf, typename ignore_expr_restriction_adapter<DT>::RestrictionFunction f, DT value = DT()) {
  bf.set_restriction(create_bitfield_restriction<DT>(create_ignore_expr_restriction_adapter<DT>(f, value), "ignore access restriction"));
}

template <typename DT>
inline void set_read_error_restriction(bitfield<DT>& bf, typename error_expr_restriction_adapter<DT>::RestrictionFunction f) {
  bf.set_read_restriction(create_bitfield_restriction<DT>(create_error_expr_restriction_adapter<DT>(f), "error read restriction"));
}

template <typename DT>
inline void set_write_error_restriction(bitfield<DT>& bf, typename error_expr_restriction_adapter<DT>::RestrictionFunction f) {
  bf.set_write_restriction(create_bitfield_restriction<DT>(create_error_expr_restriction_adapter<DT>(f), "error write restriction"));
}

template <typename DT>
inline void set_error_restriction(bitfield<DT>& bf, typename error_expr_restriction_adapter<DT>::RestrictionFunction f) {
  bf.set_restriction(create_bitfield_restriction<DT>(create_error_expr_restriction_adapter<DT>(f), "error access restriction"));
}
