...
#define SCML2_ASSERT_TO(t, a) \
if (a) { \
} else \
  SCML2_ERROR_TO(t, FATAL_ERROR)


// internal usage only

#define SCML2_INFO_ENABLED(t) true
#define SCML2_INFO(type, ...) (std::cout)
#define SCML2_WARNING_ENABLED(t) true
#define SCML2_WARNING(type, ...) (std::cout)
#define SCML2_ERROR_ENABLED(t) true
#define SCML2_ERROR(type, ...) (std::cout)
#define SCML2_MODEL_INTERNAL_ENABLED(t, type) true
