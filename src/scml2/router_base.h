...
public:
  ...
  bool get_forward_unmapped_ignore_accesses_into_callback() const;
  void set_forward_unmapped_ignore_accesses_into_callback(bool value);
protected:
...
private:
  ...
  mapped_range* getMappedRange(tlm::tlm_generic_payload& trans);
private:
...
private:
  static bool sPreVReleaseTlmIgnoreBehavior;
  streams* mTheStreams;
  ...
  bool mForwardUnmappedIgnoreAccessesIntoCallback{};
};
