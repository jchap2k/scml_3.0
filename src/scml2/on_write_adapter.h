...
inline
on_write_adapter<DT, ADAPTER, clear_on_write_functor, POST_WRITE>
create_clear_on_write_adapter(ADAPTER f, reg<DT>& r)
{
  return on_write_adapter<DT, ADAPTER, clear_on_write_functor, POST_WRITE>(f, r);
}
...
template <bool POST_WRITE, typename DT, typename ADAPTER>
inline
on_write_adapter<DT, ADAPTER, set_on_write_functor, POST_WRITE>
create_set_on_write_adapter(ADAPTER f, reg<DT>& r)
{
  return on_write_adapter<DT, ADAPTER, set_on_write_functor, POST_WRITE>(f, r);
}
