...
public:
  ...
  const char* getName() const override { return mT.getName(); }
  void setPVInterfaceType(scml::PVInterfaceType pvInterfaceType) override
  {
    mT.setPVInterfaceType(pvInterfaceType);
  }
  scml::PVInterfaceType getPVInterfaceType() const override
  {
  ...
  void register_port(sc_core::sc_port_base& port, const char* if_typename) override
  {
    mT.register_port(port, if_typename);
  }
public:
  sc_object* get_interface_as_sc_object() override
  {
