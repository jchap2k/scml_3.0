...
class simple_target_socket :
  public scml2::ft_target_socket<BUSWIDTH, TYPES>
{
...
public:
  ...
  typedef scml2::ft_target_socket<BUSWIDTH, TYPES>       base_type;
...
public:
  ...
  {
    base_type::bind(m_fw_process);  /*snps-changed*/
  }
                                   ...
                                   sc_core::sc_time& t)
    {
      if (m_nb_transport_ptr) {
        ...
        if (phase == tlm::BEGIN_REQ) {
          ...
          /*snps-moved*/
          process_handle_class * ph = m_process_handle.get_handle(&trans,0);  /*snps-changed*/

          if (!ph) { // create new dynamic process
            ph = new process_handle_class(&trans,0);  /*snps-changed*/
            /*snps-moved-begin*/
            sc_core::sc_spawn_options opts;
            ...
            sc_core::sc_spawn(sc_bind(&fw_process::nb2b_thread,this, ph, sc_ref(trans), (sc_core::sc_event*)0),  /*snps-changed*/
...
// dynamic process handler for nb2b conversion
    ...
    public:
      process_handle_class(transaction_type * trans,
                           sc_core::sc_event* ):  /*snps-changed*/
        m_trans(trans),m_e(new sc_core::sc_event()),m_suspend(false){}  /*snps-changed*/
    ...
    public:
      ...
      process_handle_class* get_handle(transaction_type *trans,sc_core::sc_event* )  /*snps-changed*/
      {
        typename std::vector<process_handle_class*>::iterator it;
    ...
    void nb2b_thread(process_handle_class* h,transaction_type &trans1, sc_core::sc_event *)  /*snps-changed*/
    {
      transaction_type *trans = &trans1;
      tlm::tlm_sync_enum ret_val;  /*snps-changed*/
      ...
      while(1) {
        ...
        /*snps-changed-begin*/
        ret_val = m_owner->bw_nb_transport(*trans, phase, t);

        if (ret_val == tlm::TLM_ACCEPTED ) {

          m_response_in_progress = true;
        }
        if(ret_val == tlm::TLM_UPDATED ){

          //If ret_val is TLM_UPDATED phase should be advanced to END_RESP
        ...
        sc_core::wait(*h->m_e);  /*snps-changed*/
      }
    }
