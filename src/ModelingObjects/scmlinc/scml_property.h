...
protected:
  ...
  friend class PropertyTest_ModuleProperty_Test;
};
...
public:
  ...
  SNPS_VP_API scml_property(const scml_property<int>& other);
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property<unsigned int>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);  
  SNPS_VP_API virtual ~scml_property();
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property<long long>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);
  SNPS_VP_API virtual ~scml_property();
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property<unsigned long long>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);  
  SNPS_VP_API virtual ~scml_property();
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property<bool>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);  
  SNPS_VP_API virtual ~scml_property();
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property<double>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);
  SNPS_VP_API virtual ~scml_property();
...
public:
  ...
  SNPS_VP_API explicit scml_property(const ::std::string& name);
  SNPS_VP_API scml_property(const scml_property< ::std::string>& other);
  SNPS_VP_API scml_property(const ::std::string& name, value_type default_value);  
  SNPS_VP_API virtual ~scml_property();
